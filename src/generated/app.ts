...
// Mount API routes
const { default: router_0 } = await import('../api/admin.js');
app.route('/api', router_0);
const { default: router_1 } = await import('../api/categories.js');
app.route('/api', router_1);
const { default: router_2 } = await import('../api/chat.js');
app.route('/api', router_2);
const { default: router_3 } = await import('../api/config.js');
app.route('/api', router_3);
const { default: router_4 } = await import('../api/customers.js');
app.route('/api', router_4);
const { default: router_5 } = await import('../api/documents.js');
app.route('/api', router_5);
const { default: router_6 } = await import('../api/inventory.js');
app.route('/api', router_6);
const { default: router_7 } = await import('../api/invoices.js');
app.route('/api', router_7);
const { default: router_8 } = await import('../api/orders.js');
app.route('/api', router_8);
const { default: router_9 } = await import('../api/pricing.js');
app.route('/api', router_9);
const { default: router_10 } = await import('../api/products.js');
app.route('/api', router_10);
const { default: router_11 } = await import('../api/reports.js');
app.route('/api', router_11);
const { default: router_12 } = await import('../api/warehouses.js');
app.route('/api', router_12);
